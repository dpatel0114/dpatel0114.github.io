  ...
  return (
   ...
   { ProjectDetail.map(p => 
    <div class="card text-center " style= {{width: '28%', marginLeft:"2%"}}>
        <a href={p.project_url} target={p.target}> <img  class='card-link' src={p.img_url}  class="card-img-top" alt="..."/> </a>
        <div class="card-body">
         <h3> <a href={p.project_url} target={p.target} class="card-title card-link"> <strong> {p.title} </strong> </a> </h3>
